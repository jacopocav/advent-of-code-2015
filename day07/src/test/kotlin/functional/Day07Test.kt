...
import ceejay.advent.`Day 7 - Some Assembly Required`
import ceejay.advent.util.Input
import kotlin.test.Test
import kotlin.test.assertEquals

class Day07Test {
    private val underTest = `Day 7 - Some Assembly Required`
