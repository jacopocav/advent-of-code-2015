...
import ceejay.advent.`Day 2 - I Was Told There Would Be No Math`
import ceejay.advent.util.Input
import kotlin.test.Test
import kotlin.test.assertEquals

class Day02Test {
    private val underTest = `Day 2 - I Was Told There Would Be No Math`
